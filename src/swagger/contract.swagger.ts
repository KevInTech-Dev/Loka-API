...
const contractPath: OpenAPIV3.PathsObject = {
            ...
            schema: {
              ...
              properties: {
                ...
                landlord_signature_url: {
                  ...
                  format: 'binary',
                  description:
                    'The signed contract document signed by landlord',
                },
              },
            },
          },
  ...
  '/contracts/manualRenewal/{id}': {
    patch: {
      tags: ['Contract'],
      summary: 'Renew a contract manually',
      security: [{ bearerAuth: [] }],
      description: 'Renew a contract manually',
      parameters: [
        {
          name: 'id',
          in: 'path',
      ...
      responses: {
        '200': {
          description: 'Contract renewal successfully',
          content: {
            'application/json': {
              schema: {
                type: 'object',
